      ...
      <div className="w-full bg-base-100">
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="hero-content text-center z-10">
              <div className="max-w-2xl">
                ...
                <p className="py-6 text-gray-600 text-lg leading-relaxed">
                  At <strong>APP-GHOR</strong>, we craft innovative digital
                  experiences designed to simplify your life. Our mission is to
                  turn complex ideas into intuitive, powerful applications used
                  by millions.
                </p>
          ...
          <div className="relative -mt-16 z-20 w-full max-w-4xl mx-auto px-4">
            <img
              className="w-full drop-shadow-2xl animate-fade-in-up"
              src={hero}
              alt="App Showcase"
            />
          </div>
          ...
          <div className="w-full bg-[#632EE3] text-white py-12 mt-10">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-10 opacity-90">
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500">
                Discover our most popular applications loved by users worldwide
              </p>
            </div>
                  ...
                  <div className="card bg-base-100 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 h-full">
                    <figure className="px-6 pt-6 bg-gray-50 group-hover:bg-purple-50 transition-colors">
                      <img
                        src={app.image}
                        alt={app.title}
                        className="rounded-xl h-32 w-32 object-contain transform group-hover:scale-110 transition-transform duration-300"
                      />
                    </figure>
            ...
            <div className="text-center mt-16">
              <Link
                to="/apps"
                className="btn btn-primary btn-wide rounded-full shadow-lg text-lg normal-case"
              >
                View All Apps
              </Link>
            </div>
